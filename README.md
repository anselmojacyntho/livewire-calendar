...
![preview](https://github.com/AnselmoJacyntho/livewire-calendar/raw/master/preview.gif)
...
```bash
composer require AnselmoJacyntho/livewire-calendar
```
...
![example](https://github.com/AnselmoJacyntho/livewire-calendar/raw/master/example.png)
...
-   [Andrés Santibáñez](https://github.com/AnselmoJacyntho)
